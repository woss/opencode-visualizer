...
Systematic plan review focused on 3 quality categories: Citation Quality,
Completeness, and Actionability. Structure is pre-validated by `plan_save`—focus
on whether the plan provides actionable implementation guidance.
...
> **Note:** Saved plans are structurally validated by `plan_save` before
> storage. Format compliance (YAML frontmatter, status markers, CURRENT marker,
> numbering) is guaranteed. Focus your review on the quality aspects below.
